...
in
{
  ...
  # Walker 2.x theme: requires a directory of named files (layout.xml, item*.xml,
  # keybind.xml, preview.xml, style.css), not flat 0.x-style {name}.toml/.css.
  # The XML files are vendored from walker's bundled "default" theme; style.css
  # is customized to import omarchy colors via the runtime theme symlink so
